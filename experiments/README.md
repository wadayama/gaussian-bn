...
Four self-contained experiments built on the `gaussian_bn` public API. Each
...
```
experiments/
├── exp{1,2,3,5,6}_*.py        # run scripts
├── results/exp{1,2,3,5,6}.json  # numerical results (committed source of truth)
